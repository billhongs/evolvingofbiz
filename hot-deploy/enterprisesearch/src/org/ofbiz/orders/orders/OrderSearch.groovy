...
def getOrderSearchFacets () {
	...
	println "==========keyword======${parameters.keyword}=====${context.keyword}";
    customer = parameters.customer?.trim() ?: "";
	println "==========Customer======${parameters.customer}===${context.customer}====";
...
def searchOrderByFilters () {
	...
	println "====parameters.viewIndex============${parameters.viewIndex}";
	println "====parameters.viewIndex============${parameters.viewSize}";
    channel = parameters.channel;
