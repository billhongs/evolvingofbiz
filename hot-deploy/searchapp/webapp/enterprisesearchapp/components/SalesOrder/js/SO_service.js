...
orderSearchServices.service("orderSearchService" ,['$http','getPostRequestPromise', function($http, getPostRequestPromise) {

 
     this.getOrderResultsByKeyword = function(parameters) {
    ...
    this.getOrderFacetsByParameter = function(urlParam) {
    
        var facetsUrl= "http://localhost:8080/enterprisesearch/control/FindOrderFacets?"+urlParam;
            facetPromise = $http.post(facetsUrl);
      return facetPromise;        
    };
        
    this.getOrderResultsByParameter = function(urlParam) {
    
        var resultUrl = "http://localhost:8080/enterprisesearch/control/FindOrders?"+urlParam;
